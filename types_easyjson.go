	...
	for !in.IsDelim('}') {
		...
		case "sortFacetValuesBy":
			if in.IsNull() {
				...
				in.Delim('{')
				out.SortFacetValuesBy = make(map[string]string)
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v105 string
					v105 = string(in.String())
					(out.SortFacetValuesBy)[key] = v105
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo30(out *jwriter.Writer, in Faceting) {
	...
	}
	{
		...
		if in.SortFacetValuesBy == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v106First := true
			for v106Name, v106Value := range in.SortFacetValuesBy {
				if v106First {
					v106First = false
				} else {
					out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "results":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v107 map[string]interface{}
					if in.IsNull() {
						in.Skip()
					} else {
						in.Delim('{')
						v107 = make(map[string]interface{})
						for !in.IsDelim('}') {
							key := string(in.String())
							in.WantColon()
							var v108 interface{}
					...
					out.Results = append(out.Results, v107)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	_ = first
	{
		...
		if in.Results == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v109, v110 := range in.Results {
				...
				if v110 == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
					out.RawString(`null`)
				} else {
					out.RawByte('{')
					v111First := true
					for v111Name, v111Value := range v110 {
						if v111First {
							v111First = false
						} else {
							out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "rankingRules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RankingRules = append(out.RankingRules, v118)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "searchableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SearchableAttributes = append(out.SearchableAttributes, v119)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "displayedAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.DisplayedAttributes = append(out.DisplayedAttributes, v120)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "stopWords":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.StopWords = append(out.StopWords, v121)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "filterableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FilterableAttributes = append(out.FilterableAttributes, v124)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "sortableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SortableAttributes = append(out.SortableAttributes, v125)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "swaps":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v126 SwapIndexesParams
					(v126).UnmarshalEasyJSON(in)
					out.Swaps = append(out.Swaps, v126)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo35(out *jwriter.Writer, in Details) {
	...
	if len(in.RankingRules) != 0 {
		...
		{
			out.RawByte('[')
			for v127, v128 := range in.RankingRules {
				if v127 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SearchableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v129, v130 := range in.SearchableAttributes {
				if v129 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.DisplayedAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v131, v132 := range in.DisplayedAttributes {
				if v131 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.StopWords) != 0 {
		...
		{
			out.RawByte('[')
			for v133, v134 := range in.StopWords {
				if v133 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Synonyms) != 0 {
		...
		}
		{
			out.RawByte('{')
			v135First := true
			for v135Name, v135Value := range in.Synonyms {
				if v135First {
					v135First = false
				} else {
					out.RawByte(',')
	...
	if len(in.FilterableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v138, v139 := range in.FilterableAttributes {
				if v138 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SortableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v140, v141 := range in.SortableAttributes {
				if v140 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "IndexUIDS":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.IndexUIDS = append(out.IndexUIDS, v145)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Statuses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v146 TaskStatus
					v146 = TaskStatus(in.String())
					out.Statuses = append(out.Statuses, v146)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Types":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v147 TaskType
					v147 = TaskType(in.String())
					out.Types = append(out.Types, v147)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "CanceledBy":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v148 int64
					v148 = int64(in.Int64())
					out.CanceledBy = append(out.CanceledBy, v148)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo36(out *jwriter.Writer, in DeleteTasksQuery) {
	...
	}
	{
		...
		if in.IndexUIDS == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v151, v152 := range in.IndexUIDS {
				if v151 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Statuses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v153, v154 := range in.Statuses {
				if v153 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.CanceledBy == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v157, v158 := range in.CanceledBy {
				if v157 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "IndexUIDS":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.IndexUIDS = append(out.IndexUIDS, v160)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Statuses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v161 TaskStatus
					v161 = TaskStatus(in.String())
					out.Statuses = append(out.Statuses, v161)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Types":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v162 TaskType
					v162 = TaskType(in.String())
					out.Types = append(out.Types, v162)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo40(out *jwriter.Writer, in CancelTasksQuery) {
	...
	_ = first
	{
		...
		if in.UIDS == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v163, v164 := range in.UIDS {
				if v163 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v164))
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.IndexUIDS == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v165, v166 := range in.IndexUIDS {
				if v165 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Statuses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v167, v168 := range in.Statuses {
				if v167 > 0 {
					out.RawByte(',')
				}
